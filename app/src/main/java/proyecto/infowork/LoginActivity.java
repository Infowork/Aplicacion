    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                jdatos.put("email", mEmail);
                jdatos.put("contrasena", mPassword);
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent intent=new Intent(LoginActivity.this,ExitoActivity.class);
                ...
                editor.putString("contrasena",mPassword);
                if(editor.commit()){
                    Toast.makeText(LoginActivity.this,"Login almacenado",Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(LoginActivity.this,"Error al almacenar el login",Toast.LENGTH_LONG).show();
                }
                finish();
            } else {
